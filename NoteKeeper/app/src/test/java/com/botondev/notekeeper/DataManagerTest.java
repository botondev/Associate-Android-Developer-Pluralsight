...
public class DataManagerTest {
    ...
    public void createNewNote() throws Exception {
        final CourseInfo courseExpected = sDataManager.getCourse("android_async");
        final String noteTitleExpected = "Test note title";
        final String noteTextExpected = "This is the body text of my test note";

        int noteIndex = sDataManager.createNewNote();
        NoteInfo newNote = sDataManager.getNotes().get(noteIndex);
        newNote.setCourse(courseExpected);
        newNote.setTitle(noteTitleExpected);
        newNote.setText(noteTextExpected);

        NoteInfo compareNote = sDataManager.getNotes().get(noteIndex);
        assertEquals(courseExpected, compareNote.getCourse());
        assertEquals(noteTitleExpected, compareNote.getTitle());
        assertEquals(noteTextExpected, compareNote.getText());
